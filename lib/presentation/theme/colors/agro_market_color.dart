...
@immutable
class AgroMarketColor extends Color implements WidgetStateProperty<Color> {
  const AgroMarketColor(
    super.value, {
    Color? light,
    Color? dark,
    Color? hover,
...
extension AgroMarketColorExtensions on AgroMarketColor {
  AgroMarketColor lerp(AgroMarketColor? other, double t) {
    return AgroMarketColor(
